  ...
  <nav className="fixed w-full bg-white shadow-sm z-50">
    <div className="container mx-auto px-6 py-4">
      <div className="flex justify-between items-center">
        <div className="text-2xl font-bold gradient-text">Coders Crew</div>
  ...
  <section id="portfolio" className="py-20 bg-white">
    <div className="container mx-auto px-6">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="portfolio-overlay absolute inset-0 bg-blue-600 bg-opacity-90 flex items-center justify-center p-6">
              <div className="text-center">
                ...
                <p className="text-blue-100 mb-4">
                  Custom-built online store with advanced inventory management
                </p>
            ...
            <div className="portfolio-overlay absolute inset-0 bg-purple-600 bg-opacity-90 flex items-center justify-center p-6">
              <div className="text-center">
                ...
                <p className="text-purple-100 mb-4">
                  Cross-platform mobile application with health integrations
                </p>
        ...
        {/* Project 3 */}
        <div className="portfolio-item rounded-xl overflow-hidden shadow-lg fade-in delay-2">
          <div className="relative">
            <img
              ...
              className="w-full h-64 object-cover"
            />
            <div className="portfolio-overlay absolute inset-0 bg-green-600 bg-opacity-90 flex items-center justify-center p-6">
              <div className="text-center">
                <h3 className="text-white text-xl font-bold mb-2">
                  Brand Identity Package
                </h3>
                <p className="text-green-100 mb-4">
                  Complete visual identity for a startup company
                </p>
                <span className="inline-block bg-white text-green-600 px-4 py-2 rounded-lg font-medium">
                  Digital Graphics
                </span>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">contact@Coders Crew.dev</p>
              </div>
            </div>
            <div className="flex items-start">
    ...
    <div className="container mx-auto px-6">
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="mb-6 md:mb-0">
          <div className="text-2xl font-bold gradient-text mb-4">Coders Crew</div>
